...
#ifndef SAUTIL_X86_INTREADWRITE_H
#define SAUTIL_X86_INTREADWRITE_H
...
#define SA_COPY128U SA_COPY128U
static sa_always_inline void SA_COPY128U(void *d, const void *s)
{
...
#endif /* SAUTIL_X86_INTREADWRITE_H */
