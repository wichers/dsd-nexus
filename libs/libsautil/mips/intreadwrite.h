...
#ifndef SAUTIL_MIPS_INTREADWRITE_H
#define SAUTIL_MIPS_INTREADWRITE_H
...
#define SA_RN32 SA_RN32
static sa_always_inline uint32_t SA_RN32(const void *p)
{
...
#endif /* SAUTIL_MIPS_INTREADWRITE_H */
