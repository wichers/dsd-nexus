...
#ifndef SAUTIL_MEM_INTERNAL_H
#define SAUTIL_MEM_INTERNAL_H
 ...
 */
    ...
    #define DECLARE_ALIGNED_T(n,t,v)    alignas(SAMIN(n, 16)) t v
    #define DECLARE_ASM_ALIGNED(n,t,v)  alignas(SAMIN(n, 16)) t sa_used v
    #define DECLARE_ASM_CONST(n,t,v)    alignas(SAMIN(n, 16)) static const t sa_used v
#elif defined(_MSC_VER)
    #define DECLARE_ALIGNED_T(n,t,v)    __declspec(align(n)) t v
    #define DECLARE_ASM_ALIGNED(n,t,v)  __declspec(align(n)) t sa_used v
    #define DECLARE_ASM_CONST(n,t,v)    __declspec(align(n)) static const t sa_used v
#else
    #define DECLARE_ALIGNED_T(n,t,v)    alignas(n) t v
    #define DECLARE_ASM_ALIGNED(n,t,v)  alignas(n) t sa_used v
    #define DECLARE_ASM_CONST(n,t,v)    alignas(n) static const t sa_used v
#endif
