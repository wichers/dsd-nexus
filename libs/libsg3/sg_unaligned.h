...
{
        __put_unaligned_be16((val >> 16) & 0xffff, p);
        __put_unaligned_be16(val & 0xffff, p + 2);
}

/* Assume 48 bit value placed in uint64_t */
static inline void __put_unaligned_be48(uint64_t val, uint8_t *p)
{
        __put_unaligned_be16((val >> 32) & 0xffff, p);
        __put_unaligned_be32(val & 0xffffffff, p + 2);
}

static inline void __put_unaligned_be64(uint64_t val, uint8_t *p)
{
        __put_unaligned_be32((val >> 32) & 0xffffffff, p);
        __put_unaligned_be32(val & 0xffffffff, p + 4);
}
...
{
        __put_unaligned_le16((val >> 16) & 0xffff, p + 2);
        __put_unaligned_le16(val & 0xffff, p);
}

static inline void __put_unaligned_le64(uint64_t val, uint8_t *p)
{
        __put_unaligned_le32((val >> 32) & 0xffffffff, p + 4);
        __put_unaligned_le32(val & 0xffffffff, p);
}
