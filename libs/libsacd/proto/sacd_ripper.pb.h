...
#define ServerRequest_type_ENUMTYPE ServerRequest_Type

#define ServerResponse_type_ENUMTYPE ServerResponse_Type
...
#define SACD_RIPPER_PB_H_MAX_SIZE                ServerResponse_size
